...
from emergent_specialization.reporting.analysis import RunBundle, load_run, sha256_file
...
def build_run_notebook(run_dir: Path, report_dir: Path) -> Any:
    ...
    cells = [
        _code_cell(
            ...
            "from emergent_specialization.reporting.runtime import RunReport\n\n"
...
def build_comparison_notebook(run_dirs: Sequence[Path], report_dir: Path) -> Any:
    ...
    cells = [
        _code_cell(
            "from IPython.display import display\n"
            "import matplotlib.pyplot as plt\n"
            "from emergent_specialization.reporting.runtime import ComparisonReport\n\n"
