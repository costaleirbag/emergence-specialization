...
from emergent_specialization.studies.ecology.ecology_transfer import _append_event, _atomic_json, _logical_observation, _mean, _sample_sd
...
from emergent_specialization.studies.ecology.semantic_ecology import GEOMETRY_ECOLOGIES, OPEGeometryV2Ecology, Case, stable_hash
from emergent_specialization.studies.ecology.transfer_operator import (analytical_jacobian, block_modes, block_matrix,
...
def _audit_one(geometry: str, seed: int, family: str) -> dict[str, Any]:
    ...
    return {"geometry": geometry, "seed": seed, "family": family, "oracle_pass": all(ecology.solve(env, family, p.fields) == p.expected for p in probes),
            ...
            "predictive_identifiability_h4": __import__("emergent_specialization.studies.ecology.semantic_ecology", fromlist=["predictive_identifiability"]).predictive_identifiability(ecology, env, family, 4)["predictively_identifiable"],
            "predictive_identifiability_h8": __import__("emergent_specialization.studies.ecology.semantic_ecology", fromlist=["predictive_identifiability"]).predictive_identifiability(ecology, env, family, 8)["predictively_identifiable"]}
