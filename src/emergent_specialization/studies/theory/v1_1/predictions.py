...
from emergent_specialization.studies.theory.v1.dynamics import transfer_operator
from emergent_specialization.studies.theory.v1.forensic_repair import centered_spectrum
