...
from emergent_specialization.studies.theory.v1.dynamics import centered_projector, jacobian, retention, transfer_operator, psi_spec
from emergent_specialization.studies.theory.v1.micro_design import ECOLOGIES, K_VALUES, MICRO_SEEDS, MACRO_BETAS, MACRO_CHECKPOINTS, macro_cells
...
from emergent_specialization.studies.theory.v1.macro_runner import _lid
...
def _micro_unit_estimates() -> tuple[dict[tuple[str, int, int], np.ndarray], dict[tuple[str, int, int], np.ndarray], dict[tuple[str, int, int], dict[str, float]], dict[tuple[str, int, int], list[np.ndarray]]]:
    ...
    from emergent_specialization.studies.theory.v1.micro_design import double_swaps, single_swaps
...
def reconstruct_k() -> dict[str, Any]:
    ...
    from emergent_specialization.studies.theory.v1.micro_design import single_swaps
    for ecology in ECOLOGIES:
        for k in K_VALUES:
