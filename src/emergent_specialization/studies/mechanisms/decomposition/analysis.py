...
from emergent_specialization.studies.theory.v1_1.replication import ECOLOGIES, MACRO_CELLS_V11, SOCIAL_SEEDS_V11
from emergent_specialization.studies.theory.v1_1.analysis import _bits, _lid, load_jsonl
