...
from emergent_specialization.core.agents import DEFAULT_SYSTEM_PROMPT, ExperimentalAgent, stable_hash
...
from emergent_specialization.core.environment import HiddenWorldEnvironment, task_prompt
