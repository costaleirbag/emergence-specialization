...
from .dynamics import critical_beta, jacobian, spectral_summary, classify_regime, transfer_operator
from .micro_design import ECOLOGIES, K_VALUES, macro_cells
...
def predictions_for_k(k_matrix: Sequence[Sequence[float]], k: int) -> list[dict[str, Any]]:
    ...
    for cell in macro_cells():
        ...
        spectrum = spectral_summary(operator)
