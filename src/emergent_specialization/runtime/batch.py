...
from emergent_specialization.core.agents import stable_hash
...
def plan_batch(path: str | Path) -> list[PlannedRun]:
    ...
    for config_value in config_paths:
        ...
        for seed in seeds:
            ...
            command_parts = (
                ("uv", "run", "python", "-m", "emergent_specialization.runtime.experiment", "--config", str(config_path), "--seed", str(seed), "--output-dir", str(output_root), "--confirm-real")
