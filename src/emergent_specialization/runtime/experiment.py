...
from emergent_specialization.core.agents import ExperimentalAgent, assert_initial_symmetry, stable_hash
from emergent_specialization.core.config import RunConfig, config_from_mapping, load_config
...
from emergent_specialization.core.interventions import InterventionSpec, apply_memory_intervention
from emergent_specialization.core.logging import RunLogger
from emergent_specialization.core.memory import MemoryPolicy
from emergent_specialization.metrics.behavioral import competence_matrix
...
from emergent_specialization.core.journal import ExecutionJournal
from emergent_specialization.core.models import AgentResponse, Experience, InferenceRecord, ProbeObservation, Task
...
from emergent_specialization.providers import DeepSeekDirectBackend, LLMBackend, MockBackend, OMPBackend
from emergent_specialization.core.retry import retry_delay
from emergent_specialization.core.router import ConfidenceRouter, RandomRouter, RouterDecision
    ...
    async def run(self) -> Path:
        ...
        try:
            ...
            print(
                ...
                f"resume: uv run python -m emergent_specialization.runtime.experiment --resume {logger.run_dir} --confirm-real",
                flush=True,
            )
            raise
